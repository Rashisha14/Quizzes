      ...
      <main className="relative z-10 mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-16 md:grid-cols-2">
        ...
        <section className="order-2 md:order-1">
          ...
          <h1 className="mt-5 text-4xl font-extrabold tracking-tight text-white md:text-5xl">
            Join <span className="text-amber-400">QuizArrow</span> Today
          </h1>
        ...
        <section className="order-1 md:order-2">
          <div className="flex min-h-140 items-center justify-center">
            <div className="mx-auto w-full max-w-md rounded-2xl border border-gray-700 bg-gray-900 p-8 shadow-xl backdrop-blur-md">
              <div className="mb-6 text-center">
                <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-100/10">
                  <LogoIcon />
                </div>
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                <div className="mt-3 flex items-center justify-between text-sm">
                  <Link to="/user/signin" className="font-medium text-amber-400 hover:text-amber-300">
...
function LogoIcon() { /* same as your original */ return (
...
function UserIcon({ className = "h-4 w-4" }) { /* same */ return (
...
function LockIcon({ className = "h-4 w-4" }) { /* same */ return (
  <svg viewBox="0 0 24 24" className={className}>
    <path fill="currentColor" d="M17 9h-1V7a4 4 0 1 0-8 0v2H7a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2Zm-6 7.73V18h2v-1.27a2 2 0 1 0-2 0ZM9 7a3 3 0 1 1 6 0v2H9Z"/>
  </svg>
);}
function ArrowRightIcon({ className = "h-4 w-4" }) { /* same */ return (
  <svg viewBox="0 0 24 24" className={className}>
    <path fill="currentColor" d="M13 5l7 7-7 7v-4H4v-6h9V5z"/>
  </svg>
);}
function TrophyIcon() { /* same */ return (
  <svg viewBox="0 0 24 24" className="mt-0.5 h-5 w-5 text-amber-400">
    <path fill="currentColor" d="M18 2h-2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1H6a1 1 0 0 0-1 1v2a5 5 0 0 0 4 4.9V12H7a1 1 0 0 0-1 1v1h12v-1a1 1 0 0 0-1-1h-2V9.9A5 5 0 0 0 19 5V3a1 1 0 0 0-1-1Zm-1 3a3 3 0 0 1-2 2.816V4h2v1ZM7 4h2v3.816A3 3 0 0 1 7 5V4Zm-2 17h14v2H5v-2Z"/>
  </svg>
);}
function LightningIcon() { /* same */ return (
  <svg viewBox="0 0 24 24" className="mt-0.5 h-5 w-5 text-indigo-400">
    <path fill="currentColor" d="M13 2L3 14h7l-1 8 10-12h-7l1-8z"/>
  </svg>
);}
function ShieldIcon() { /* same */ return (
  <svg viewBox="0 0 24 24" className="mt-0.5 h-5 w-5 text-emerald-400">
    <path fill="currentColor" d="M12 2l7 4v6c0 5-3.5 9-7 10-3.5-1-7-5-7-10V6l7-4z"/>
  </svg>
);}
function SparklesIcon() { /* same */ return (
  <svg viewBox="0 0 24 24" className="mt-0.5 h-5 w-5 text-pink-400">
    <path fill="currentColor" d="M5 3l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4zm14 6l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2zm-6 5l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4z"/>
  </svg>
);}
